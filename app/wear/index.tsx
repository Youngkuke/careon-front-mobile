...
export default function WearScreen() {
  ...
  return <Screen scroll backgroundColor={CAREON_COLORS.page} contentStyle={styles.content}>
    ...
    {safeZoneEvent ? <Pressable onPress={() => pushRoute(`/safe-zone-events/${safeZoneEvent.id}`)} style={styles.exitNotice}><Ionicons color={CAREON_COLORS.danger} name="navigate-outline" size={18} /><Text style={styles.exitText}>안심 구역 이탈이 감지됐어요. 자세히 보기</Text></Pressable> : null}
